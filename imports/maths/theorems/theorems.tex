...
\newtcbtheorem[use counter=propertiescounter, number within=section]{theorem}{Théorème}{globalbox,theorembox,}{theorems}
% \crefname{theorem}{Théorème}{Théorèmes}

\newtcbtheorem[use counter=propertiescounter, number within=section]{property}{Propriété}{globalbox,theorembox}{properties}
% \crefname{property}{Propriété}{Propriétés}

\newtcbtheorem[use counter=propertiescounter, number within=section]{corollary}{Corollaire}{globalbox,theorembox}{corollaries}
% \crefname{corollary}{Corollaire}{Corollaires}

\newtcbtheorem[use counter=propertiescounter, number within=section]{lemma}{Lemme}{globalbox,theorembox}{lemmas}
...
\newtcbtheorem[use counter=propertiescounter, number within=section]{definition}{Définition}{globalbox,definitionbox}{definitions}
...
\newtcbtheorem[use counter=propertiescounter, number within=section]{command}{Commande}{globalbox,commandbox}{commands}
...
\newtcbtheorem[use counter=propertiescounter, number within=section]{exercise}{Exercice}{globalbox,exercisebox}{exercises}
% \crefname{exercise}{Exercice}{Exercices}

\newtcbtheorem[use counter=propertiescounter, number within=section]{example}{Exemple}{globalbox,exercisebox, leftrule=0pt, rightrule=0pt}{examples}
...
\newtcbtheorem{testexercise}{Exercice}{globalbox,testexercisebox}{testexercises}
...
\newtcbtheorem[use counter=propertiescounter, number within=section]{remark}{Remarque}{remarkbox}{remarks}
...
\newtcbtheorem[use counter=propertiescounter, number within=section]{method}{Méthode}{remarkbox,methodbox}{methods}
...
\newtcbtheorem[number within=subject]{subjectexercise}{Exercice}{globalbox,exercisebox}{exercises}
...
\newtcbox{\rating}{enhanced,nobeforeafter,tcbox raise base,boxrule=0.4pt,top=0mm,bottom=0mm,
  ...
  rectangle node[text=white,font=\bfseries\tiny,rotate=90] {PTS} ([xshift=4mm]frame.north west);\end{tcbclipinterior}}}
